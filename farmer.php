...
if(isset($_POST['btn']))
{
$qry=mysql_query("select * from fregister where uname='$uname' && psw='$password'");
...
<form id="form1" name="form1" method="post" action="">
	   <table width="48%" border="0" align="center">
         <tr>
           <td colspan="2" rowspan="1"><div align="center" class="style1"><strong><font size="+1">Farmer Login</font> </div></td>
		 </tr>
			<tr>
		<td width="41%">&nbsp;</td>
		    <td width="35%">&nbsp;</td>
         ...
         <tr>
		  ...
		  <tr>
           <td>&nbsp;</td>
           <td width="24%"><label>
            <a href="fregister.php">Farmer Register</a>
           </label></td>
         </tr>
